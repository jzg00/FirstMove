...
const logistics: SignalDataset = {
  ...
  rows: [
    { region: 'Pacific Northwest', carrier: 'FreshDirect Parcel', week: 'W17', failureRate: 0.14, prevWeekRate: 0.06, rootCause: 'Temperature excursion in transit', affectedBoxes: 3820, customerImpactScore: 8.4, dollarImpact: 91200, reshipRate: 0.71 },
    ...
    { region: 'Pacific Northwest', carrier: 'FreshDirect Parcel', week: 'W16', failureRate: 0.06, prevWeekRate: 0.05, rootCause: 'Temperature excursion in transit', affectedBoxes: 1640, customerImpactScore: 5.0, dollarImpact: 39200, reshipRate: 0.68 },
...
const menu: SignalDataset = {
  ...
  rows: [
    { recipeId: 'HF-2841', recipeName: 'Smoky BBQ Chicken Flatbread', mealType: 'Family', avgRating: 3.6, prevAvgRating: 4.1, ratingTrend: -0.5, weeklyOrders: 18400, fulfillmentDifficulty: 'high', ingredientCostPerServing: 5.82, prevIngredientCost: 5.21, cancelledDueToStock: 0.08, weeksOnMenu: 6 },
    ...
    { recipeId: 'HF-2994', recipeName: 'Korean BBQ Beef Bowls', mealType: 'Market', avgRating: 4.5, prevAvgRating: 4.5, ratingTrend: 0.0, weeklyOrders: 22100, fulfillmentDifficulty: 'low', ingredientCostPerServing: 6.40, prevIngredientCost: 6.35, cancelledDueToStock: 0.00, weeksOnMenu: 4 },
    ...
    { recipeId: 'HF-3155', recipeName: 'Lemon Herb Chicken Piccata', mealType: 'Market', avgRating: 4.4, prevAvgRating: 4.3, ratingTrend: 0.1, weeklyOrders: 15800, fulfillmentDifficulty: 'low', ingredientCostPerServing: 5.60, prevIngredientCost: 5.55, cancelledDueToStock: 0.00, weeksOnMenu: 2 },
    { recipeId: 'HF-2877', recipeName: 'Shrimp Tacos with Mango Slaw', mealType: 'Family', avgRating: 3.7, prevAvgRating: 4.0, ratingTrend: -0.3, weeklyOrders: 13500, fulfillmentDifficulty: 'medium', ingredientCostPerServing: 7.20, prevIngredientCost: 6.50, cancelledDueToStock: 0.03, weeksOnMenu: 5 },
    ...
    { recipeId: 'HF-2861', recipeName: 'Steak & Chimichurri with Roasted Veg', mealType: 'Market', avgRating: 4.8, prevAvgRating: 4.7, ratingTrend: 0.1, weeklyOrders: 9100, fulfillmentDifficulty: 'low', ingredientCostPerServing: 10.40, prevIngredientCost: 9.10, cancelledDueToStock: 0.00, weeksOnMenu: 5 },
    ...
    { recipeId: 'HF-2918', recipeName: 'Cheesy Stuffed Peppers', mealType: 'Family', avgRating: 3.5, prevAvgRating: 3.8, ratingTrend: -0.3, weeklyOrders: 14200, fulfillmentDifficulty: 'high', ingredientCostPerServing: 5.10, prevIngredientCost: 4.80, cancelledDueToStock: 0.06, weeksOnMenu: 10 },
    ...
    { recipeId: 'HF-2966', recipeName: 'Chicken Caesar Flatbread Pizza', mealType: 'Family', avgRating: 4.0, prevAvgRating: 4.4, ratingTrend: -0.4, weeklyOrders: 19600, fulfillmentDifficulty: 'high', ingredientCostPerServing: 5.50, prevIngredientCost: 4.95, cancelledDueToStock: 0.07, weeksOnMenu: 9 },
    { recipeId: 'HF-3130', recipeName: 'Butter Chicken with Basmati', mealType: 'Market', avgRating: 4.6, prevAvgRating: 4.5, ratingTrend: 0.1, weeklyOrders: 17300, fulfillmentDifficulty: 'low', ingredientCostPerServing: 6.10, prevIngredientCost: 5.95, cancelledDueToStock: 0.00, weeksOnMenu: 3 },
    { recipeId: 'HF-2839', recipeName: 'Classic Beef Bolognese', mealType: 'Family', avgRating: 4.3, prevAvgRating: 4.5, ratingTrend: -0.2, weeklyOrders: 21000, fulfillmentDifficulty: 'medium', ingredientCostPerServing: 6.90, prevIngredientCost: 6.10, cancelledDueToStock: 0.02, weeksOnMenu: 12 },
    ...
    { recipeId: 'HF-3220', recipeName: 'Spicy Sausage & Kale Pasta', mealType: 'Market', avgRating: 4.4, prevAvgRating: 4.3, ratingTrend: 0.1, weeklyOrders: 13100, fulfillmentDifficulty: 'low', ingredientCostPerServing: 5.75, prevIngredientCost: 5.70, cancelledDueToStock: 0.00, weeksOnMenu: 2 },
